...
class Profesional extends Model
{
    ...
    {
    return $this->belongsToMany(Proyecto::class,'motivo_profesional_proyecto')->withPivot('proyecto_id')
        ->withTimestamps();
+++    }
+++    public function motivo()
+++    {
+++        return $this->belongsToMany(Motivo::class,'motivo_profesional_proyecto')->withPivot('motivo_id')
            ->withTimestamps();
++      }
