...
<div>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-10">
            {!! Form::text('AP_MAT_EST', old('AP_MAT_EST'), ['class'=>'form-control', 'data-parsley-pattern'=>"^[a-zA-Z ]+$",'placeholder'=>"Ingrese el Apellido Materno", 'required' =>'true','data-parsley-error-message'=>"Ingrese solo letras y espacios",'minlength'=>'3']) !!}
        </div>
    </div>
    <div class="form-group row">
